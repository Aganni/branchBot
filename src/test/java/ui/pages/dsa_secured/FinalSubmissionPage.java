...
public class FinalSubmissionPage extends BaseTest {
    ...
    // Step 1: Click Submit on the Login page after fee details
    ...
    // Step 2: Handle Swift Loan popup - select Yes
    public void handleSwiftLoanPopup() {
        ...
        // Click the dropdown and select Yes
    ...
    public void loginAndNavigateToGroups(String email, String password) {
        ...
        groupsTab.getByRole(AriaRole.LINK,
                new Page.GetByRoleOptions().setName(groupsLinkName)).click();
        groupsTab.waitForTimeout(2000);

        // Refresh conversations to get latest emails
        Locator refreshBtn = groupsTab.getByLabel("Refresh conversations");
        refreshBtn.waitFor(new Locator.WaitForOptions()
                .setState(WaitForSelectorState.VISIBLE).setTimeout(10000));
        refreshBtn.click();
    ...
    // (Same pattern as EntityConsentPage.openLatestEmailAndConsent)

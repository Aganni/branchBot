...
public class CoAppEntityPage extends BaseTest {
    ...
    public void verifyCompanyPan(String pan, String bizType) {
        page.waitForTimeout(2500);
        page.getByLabel(COMPANY_PAN).fill(pan);
    ...
    public void verifyUdyamDetails(String udyam) {
        ...
        Locator gstinOptions = page.locator("li[role='option']:visible, .el-select-dropdown__item:visible, [role='listbox'] [role='option']:visible");

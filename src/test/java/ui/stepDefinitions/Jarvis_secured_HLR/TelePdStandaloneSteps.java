...
import ui.pages.jarvis_secured_HLR.TelePdPage;
...
public class TelePdStandaloneSteps extends BaseTest {
    ...
    @When("HLR User completes standalone Tele PD for app {string}")
    ...
    @And("HLR User completes standalone PD Visit for the application")
    ...
    @And("HLR User completes PD Visit per-applicant with Jarvis uploads")
    ...
    @When("HLR User opens Jarvis and navigates to application {string}")
    ...
    @And("HLR User uploads Physical PD images for all applicants on Jarvis")
    ...
    @And("HLR User completes Property Visit on Jarvis")
